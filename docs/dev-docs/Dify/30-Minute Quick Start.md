...
![User Input Node](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_start.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=54df708079d522c902ab6153bc7606f4)
...
![Paramater Extractor](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_paramater_extractor.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=4f038950160d0e6184782f32c23e5524)
...
![If Condition](https://mintcdn.com/dify-6c0370d8/pukb9aJrVFLyeNW1/images/deeper_dive_if.png?w=280&fit=max&auto=format&n=pukb9aJrVFLyeNW1&q=85&s=ab236223c9c39b35c4f46f615f8745dc)
...
![List Operator](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_list_operator.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=41f57f4a1f9d684abe0ade7ed8f0fdae)
...
![Integrate Information](https://mintcdn.com/dify-6c0370d8/pukb9aJrVFLyeNW1/images/deeper_dive_info_integrate.png?w=280&fit=max&auto=format&n=pukb9aJrVFLyeNW1&q=85&s=c011b169050a552cfc5734afc0687af1)
...
3. Click the LLM node to configure it:
	...
	4. In the system prompt field, paste the following:
		In the prompt, to reference the `Doc Extractor/text` and `User Input/draft` variables in *PROVIDED MATERIALS*, type `{` or `/` and select from the list.![Reference Variable](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_reference_variable.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=6a68e655c0184762da08645dc5233e84)
		Reference Variable
		SYSTEM
		```
		# PROVIDED MATERIALS
...
![Iteration Node](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_integration.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=c6fb9955fb85b117a020c9122b93f18d)
...
3. After the Identity Style node, add another LLM node and configure it:
	...
	3. In the system prompt field, paste the following:
		...
		✅ Publication ready
		```
	4. Enable structured output.![Structured Output](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_structured_output.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=eba71d3e2282210d3dfeb8937a28c983)
		Structured Output
...
The Iteration node generates a post for each platform, but its output is a raw array of data (e.g., `[{"platform_name": "Twitter", "post_content": "..."}]`) that isn’t very readable. We need to present the results in a clearer format.That’s where the Template node comes in—it allows us to format this raw data into well-organized text using [Jinja2](https://jinja.palletsprojects.com/en/stable/) templating, ensuring the final output is user-friendly and easy to understand.

![Template Node](https://mintcdn.com/dify-6c0370d8/6mOfaeljpmK9sOmc/images/deeper_dive_template.png?w=280&fit=max&auto=format&n=6mOfaeljpmK9sOmc&q=85&s=97893b99520ac2979dd34e40de192785)
...
1. Make sure your Checklist is clear.![Check Clecklist](https://mintcdn.com/dify-6c0370d8/pukb9aJrVFLyeNW1/images/deeper_dive_checklist_clear.png?w=280&fit=max&auto=format&n=pukb9aJrVFLyeNW1&q=85&s=3ee9ef3967497e917a2aa32f428150f3)
	Check Clecklist
...
[Previous](https://docs.dify.ai/en/use-dify/getting-started/introduction)[Key Concepts](https://docs.dify.ai/en/use-dify/getting-started/key-concepts)
